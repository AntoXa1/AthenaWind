...
//<< anton
    	   ...
    	   if(  isnan(pG->U[k][j][i].d)  || isnan(pG->U[k][j][i].M1) || isnan(pG->U[k][j][i].M2) || isnan(pG->U[k][j][i].M3)){
    	   	printf( "isnan 12a before in 3d_ctu %d %d %d %e %e %e %e\n", i, j,k, pG->U[k][j][i].d, pG->U[k][j][i].M1, pG->U[k][j][i].M2, pG->U[k][j][i].M3);
    	   	getchar();
...
if(  isnan(pG->U[k][j][i].d)  || isnan(pG->U[k][j][i].M1) || isnan(pG->U[k][j][i].M2) || isnan(pG->U[k][j][i].M3)){
   	printf( "isnan 12a after in 3d_ctu %d %d %d %e %e %e %e\n", i, j,k, pG->U[k][j][i].d, pG->U[k][j][i].M1, pG->U[k][j][i].M2, pG->U[k][j][i].M3);
	getchar();
